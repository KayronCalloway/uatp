...
async def main():
    ...
    try:
        ...
        if success:
            ...
            print(f"   Real-time generator is storing capsules in SQLite database")
            print(f"   Database integration is working correctly")
            print(f"   System is ready for production use")
        else:
            print(f"\n❌ SQLITE INTEGRATION TEST FAILED!")
            print(f"   Capsules are not being stored in SQLite database")
            print(f"   Check database connection and integration layer")
