...
Agenda:
  [OK] Understand your use case
  [OK] Identify 1 AI workflow for pilot
  [OK] Review technical requirements
  [OK] Set success criteria
...
Tasks:
  [OK] Install UATP SDK (Python: pip install uatp)
  [OK] Configure credentials (API keys)
  [OK] Integrate with 1 AI workflow
  [OK] Generate first capsule

Verification:
  $ uatp verify --chain-id <your-first-chain>
  Result: "[OK] All signatures valid"
```
...
Tasks:
  [OK] Deploy HIPAA/GDPR template pack
  [OK] Run in shadow mode (detect, don't block)
  [OK] Capture 10,000+ interactions
  [OK] Review false positive rate
...
Tasks:
  [OK] Enable enforcement (10% traffic)
  [OK] Monitor blocked requests
  [OK] Tune policies (reduce false positives to <2%)
  [OK] Test circuit breaker
...
Tasks:
  [OK] Generate audit report for legal/compliance
  [OK] Present to stakeholders
  [OK] Decide: Go to production or extend pilot
...
|---------|-----------------|------|
| Can be edited? | [OK] Yes | [ERROR] No (cryptographic) |
| Proves policy ran? | [ERROR] No | [OK] Yes (sealed capsule) |
| Regulator-ready? | [ERROR] Takes weeks | [OK] 30 minutes |
| Tamper-proof? | [ERROR] No | [OK] Post-quantum crypto |
...
Stored:
  [OK] Timestamp, user ID, workflow name
  [OK] Policy check results (pass/fail)
  [OK] Content hash (SHA-256)
  [OK] Cryptographic signatures
  [OK] Model used, tokens, latency

NOT Stored:
  [ERROR] Full prompt text (unless you configure it)
  [ERROR] Full AI response (unless you configure it)
  [ERROR] PII/PHI (unless explicitly enabled)
...
1. Technical Proof
   [OK] 363 production modules (GitHub)
   [OK] 71% test coverage
   [OK] Demo works end-to-end
   [OK] Post-quantum cryptography (NIST approved)

2. Risk Mitigation
   [OK] 90-day pilot (prove it works)
   [OK] Fixed price (no surprise bills)
   [OK] Open source core (no lock-in)
   [OK] 30-day exit (clean offboarding)

3. Market Timing
   [OK] EU AI Act enforcement: 2025
   [OK] Insurance demanding AI audit trails
   [OK] No mature competitors
   [OK] First-mover advantage for you
...
```
Negotiable:
  [OK] Multi-year contracts (discount)
  [OK] High volume (custom pricing)
  [OK] Multiple workflows (bundle discount)
  [OK] Early customers (founder pricing)

Non-Negotiable:
  [ERROR] Pilot pricing ($20K fixed)
  [ERROR] Standard tiers (listed pricing)
```
...
|---------|-----------------|------|
| **Tamper-proof** | [ERROR] Logs can be edited/deleted | [OK] Cryptographic signatures |
| **Real-time policy enforcement** | [ERROR] No enforcement | [OK] Block violations before they happen |
| **AI-specific context** | [ERROR] Generic I/O logging | [OK] Captures reasoning, policies, decisions |
| **Regulator-ready reports** | [ERROR] Takes weeks to compile | [OK] Generate in 30 minutes |
| **Compliance focus** | [ERROR] Not designed for compliance | [OK] Built for HIPAA/GDPR/EU AI Act |
...
| **AI-specific** | [ERROR] No | [OK] Yes |
| **Policy enforcement** | [ERROR] Reactive (alert after) | [OK] Preventive (block before) |
| **Cryptographic proof** | [ERROR] No | [OK] Yes |
| **Audit reports** | [ERROR] Not compliance-focused | [OK] Regulator-ready |
| **Integration** | [OK] Monitors everything | [OK] Exports metrics to your monitoring |
...
| **Policy enforcement** | [ERROR] No | [OK] Yes (HIPAA, GDPR, etc.) |
| **Audit trails** | Model metrics | Decision-level audit trails |
| **Cryptographic proof** | [ERROR] No | [OK] Yes |
| **Compliance reports** | [ERROR] No | [OK] Yes |
...
| **Control** | [OK] Full control | [WARN]  Vendor dependency |
...
| **Privacy** | [ERROR] Public by default | [OK] Private by default |
| **AI-specific features** | [ERROR] None | [OK] Policy checks, reasoning capture |
