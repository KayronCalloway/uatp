            ...
            with self._model_lock:
                ...
                if self._embedding_model is None:
                    ...
                    self._reference_embeddings = {
                        "success": self._embedding_model.encode(
                            self.SUCCESS_REFERENCES
                        ),
                        "failure": self._embedding_model.encode(
                            self.FAILURE_REFERENCES
                        ),
                        "partial": self._embedding_model.encode(
