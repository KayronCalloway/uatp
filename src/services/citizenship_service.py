...
class CitizenshipService:
    ...
    def _grant_citizenship(
        ...
        self.citizenship_registry.active_citizenships[
    ...
    def create_citizenship_capsule(
        ...
        jurisdiction_obj = self.jurisdictions[citizenship["jurisdiction"]]
