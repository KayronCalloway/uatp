...
class HybridComputeAttributionInput(BaseModel):
    ...
    gpu_percentage: float = Field(ge=0, le=100, default=0.0, description="Percentage on GPU")
...
class MILFusionOptimizationInput(BaseModel):
    ...
    memory_reduction_bytes: Optional[int] = Field(None, ge=0, description="Memory savings")
...
class HardwareProfileRequest(BaseModel):
    ...
    memory_bandwidth_gbps: Optional[float] = Field(None, ge=0, description="Memory bandwidth")
...
class ANESessionCompleteRequest(BaseModel):
    ...
    total_ane_time_seconds: Optional[float] = Field(None, ge=0, description="Total ANE time")
    total_cpu_time_seconds: Optional[float] = Field(None, ge=0, description="Total CPU time")
