      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-6 bg-gray-900 rounded-lg p-6 border border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <h3 className="font-semibold text-purple-400 mb-2">Edge Types:</h3>
              <ul className="space-y-1 text-gray-300">
                <li><span className="text-gray-400">—</span> Solid: Direct relationships (integrates, creates, uses)</li>
                <li><span className="text-yellow-400">- -</span> Dashed: System interactions (evaluates, pays, assesses)</li>
                <li><span className="text-blue-400">━</span> Thick: Capsule chains (chains_to)</li>
              </ul>
            </div>
          </div>
        </div>

        <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden" style={{ height: '700px' }}>
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-900 rounded-lg p-4 border border-gray-800">
            ...
            <div className="text-sm text-gray-400">Spatial Providers</div>
          </div>
          <div className="bg-gray-900 rounded-lg p-4 border border-gray-800">
            <div className="text-3xl font-bold text-cyan-400">11</div>
            <div className="text-sm text-gray-400">Capsule Types</div>
          </div>
          <div className="bg-gray-900 rounded-lg p-4 border border-gray-800">
