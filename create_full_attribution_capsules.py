...
from crypto_utils import sign_capsule, hash_for_signature
...
class FullAttributionCapsuleCreator:
    ...
    async def create_collaboration_capsule(self) -> str:
        ...
        print(f"   ✅ Created: {capsule.capsule_id}")
        print(f"   🤝 Platforms: Claude Code, Cursor, GitHub")
    ...
    async def create_economic_analysis_capsule(self) -> str:
        ...
        print(f"   ✅ Created: {capsule.capsule_id}")
        print(f"   💎 FCDE Analysis: $5000 total value distributed")
    ...
    async def create_consensus_capsule(self) -> str:
        ...
        print(f"   ✅ Created: {capsule.capsule_id}")
        print(f"   🤖 Consensus: 4 agents, 95% agreement")
    ...
    async def create_creative_attribution_capsule(self) -> str:
        ...
        print(f"   ✅ Created: {capsule.capsule_id}")
        print(f"   🎵 Creative Work: Neo-jazz composition with IP protection")
    ...
    async def create_documentation_capsule(self) -> str:
        ...
        print(f"   ✅ Created: {capsule.capsule_id}")
        print(f"   📚 Documentation: 47 pages with full attribution tracking")
    ...
    async def create_research_capsule(self) -> str:
        ...
        print(f"   ✅ Created: {capsule.capsule_id}")
        print(f"   🔬 Research: Multi-institutional collaboration with 50k data points")
    ...
    async def _save_capsule_to_db(self, capsule: ReasoningTraceCapsule):
        ...
        try:
            ...
            print(f"   📝 Capsule data saved to local storage instead")
    ...
    async def display_creation_summary(self, capsule_ids: List[str]):
        ...
        print(f"   • Attribution Types: AI-Human, Cross-Platform, Economic, Consensus")
        print(f"   • Features Demonstrated: FCDE, Multi-Agent, Creative IP, Research")
        ...
        print(f"   🌐 Cross-platform integration")
        print(f"   🤝 Multi-agent consensus")
        print(f"   🎨 Creative work attribution")
        print(f"   📚 Documentation attribution")
