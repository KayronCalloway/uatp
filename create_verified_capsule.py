...
async def main():
    ...
    try:
        ...
        print(f"🏛️ Attribution Data: Included in metadata")
        ...
        print(f"Algorithm: Ed25519 + SHA-256")
        print(f"Security: 128-bit equivalent")
        print(f"Database: Saved to uatp_dev.db")
        print(f"Frontend: Should display 'Verified' status")
