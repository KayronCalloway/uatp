...
def create_high_significance_conversation():
    ...
    try:
        ...
        print("💬 Sending High-Significance Message (score: 2.5)")
        ...
        if response.status_code == 200:
            ...
            if result.get("capsule_created"):
                ...
                if significance < 0.6:
                    print(
                        "   ⚠️ Still below threshold! System may need AI key verification."
                    )
        else:
            print(f"   Error: {response.text}")
...
def check_system_final_status():
    ...
    print("\n" + "=" * 70)
    print("🎯 Final UATP System Status:")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if total > 0:
                ...
                print(
                    "   💡 No capsules yet - system needs valid AI API keys for reasoning generation"
                )
...
if __name__ == "__main__":
    ...
    if capsule_id:
        ...
        print("🔮 Your AI conversations with proper significance (>0.6) will now")
        print("   automatically create capsules with quantum-safe cryptography!")
    else:
        print(
