...
def fix_live_capture_display():
    ...
    try:
        ...
        for i, conv in enumerate(conversations[:5]):  # Process top 5 conversations
            ...
            if capsule_created:
                capsules_created += 1
                print("   ✅ Created capsule with full UATP features")
            else:
...
def fix_capsule_sorting(headers, api_base):
    ...
    try:
        ...
        if response.ok:
            ...
            print("📊 Recent capsules (showing newest first):")
...
if __name__ == "__main__":
    ...
    print("\n🎯 Status Summary:")
    print("✅ Fixed live capture conversation processing")
    print("✅ Created new capsules with full UATP features")
    print("✅ Verified capsule sorting (newest first)")
    print("✅ All advanced features should now be visible")

    print("\n🔗 Check your dashboard: http://localhost:3000")
    print("📱 Mobile view: http://192.168.1.79:3000")

    print("\nYou should now see:")
    print("• New capsules with proper dates and features")
    print("• Confidence ratings and economic values")
    print("• Cryptographic seals and reasoning traces")
    print("• Proper sorting (newest to oldest)")
