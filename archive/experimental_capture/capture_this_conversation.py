...
Let me build the RealTimeCapsuleGenerator class that can process live interactions and create capsules automatically when they meet the significance threshold.""",
    ...
    print("📝 Capturing current conversation exchange...")
    ...
    if capsule_id:
        ...
        try:
            with open("/Users/kay/uatp-capsule-engine/capsule_chain.jsonl") as f:
                lines = f.readlines()
        ...
        print("   (May not have met significance threshold)")
...
async def main():
    ...
    try:
        ...
        if capsule_id:
            ...
            print(
                "   The system is now capturing and creating capsules from live conversations!"
            )
            print("   📁 View in visualizer: http://localhost:8501")
            print("   🔧 Monitor in dashboard: http://localhost:8502")
        else:
            print("\n⚠️  Demo completed but no capsule created")
            print("   The conversation may not have met the significance threshold")
