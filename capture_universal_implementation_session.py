...
"""
    ...
    try:
        ...
        print(f"   • Captured with significance as metadata (not filter)")
        print(f"   • High economic weight (0.95) for important work")
        print(f"   • Universal capture philosophy applied")
        print(f"   • Democratic attribution: all interactions matter")

        print(f"\n📚 Related Documentation:")
        print(f"   • UNIVERSAL_CAPTURE_PHILOSOPHY.md - The problem and solution")
        print(f"   • UNIVERSAL_CAPTURE_IMPLEMENTATION.md - What was changed")
        print(f"   • test_universal_capture.py - Verification tests")
