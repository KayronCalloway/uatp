...
async def create_verified_capsule_via_system():
    ...
    try:
        ...
        from database.models import CapsuleModel
        ...
        print(f"")
        print(f"🎉 SUCCESS: FULLY VERIFIED CAPSULE CREATED!")
        print(f"   Capsule ID: {capsule.capsule_id}")
        print(f"   Verification Status: {'VERIFIED' if is_valid else 'NOT VERIFIED'}")
        print(f"   Creation Method: Official UATP Engine")
        print(f"   Security Level: System Authenticated")
        print(f"")
