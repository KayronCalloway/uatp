...
async def create_session_capsules():
    ...
    try:
        ...
        print(f"  - Architectural decisions and rationale")
        print(f"  - Implementation details and performance characteristics")
        print(f"  - Attribution for development work")
        print(f"  - Alignment with user requirements")
